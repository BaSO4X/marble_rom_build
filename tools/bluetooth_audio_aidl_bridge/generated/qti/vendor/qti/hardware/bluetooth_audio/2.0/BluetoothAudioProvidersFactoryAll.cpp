#define LOG_TAG "vendor.qti.hardware.bluetooth_audio@2.0::BluetoothAudioProvidersFactory"
...
#include <vendor/qti/hardware/bluetooth_audio/2.0/BnHwBluetoothAudioProvidersFactory.h>
#include <vendor/qti/hardware/bluetooth_audio/2.0/BsBluetoothAudioProvidersFactory.h>
...
const char* IBluetoothAudioProvidersFactory::descriptor("vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvidersFactory");
...
::android::hardware::Return<void> IBluetoothAudioProvidersFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>> IBluetoothAudioProvidersFactory::castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory>> IBluetoothAudioProvidersFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IBluetoothAudioProvidersFactory, ::android::hidl::base::V1_0::IBase, BpHwBluetoothAudioProvidersFactory>(
            parent, "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvidersFactory", emitError);
}
...
BpHwBluetoothAudioProvidersFactory::BpHwBluetoothAudioProvidersFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IBluetoothAudioProvidersFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("vendor.qti.hardware.bluetooth_audio@2.0", "IBluetoothAudioProvidersFactory") {
}
...
// Methods from ::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory follow.
::android::hardware::Return<void> BpHwBluetoothAudioProvidersFactory::_hidl_openProvider(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::vendor::qti::hardware::bluetooth_audio::V2_0::SessionType sessionType, openProvider_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "openProvider", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* openProvider */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider> _hidl_out_provider;
...

        {
            ...
            _hidl_out_provider = ::android::hardware::fromBinder<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider,::vendor::qti::hardware::bluetooth_audio::V2_0::BpHwBluetoothAudioProvider,::vendor::qti::hardware::bluetooth_audio::V2_0::BnHwBluetoothAudioProvider>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "openProvider", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBluetoothAudioProvidersFactory::_hidl_getProviderCapabilities(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::vendor::qti::hardware::bluetooth_audio::V2_0::SessionType sessionType, getProviderCapabilities_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&sessionType);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "getProviderCapabilities", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* getProviderCapabilities */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        const ::android::hardware::hidl_vec<::vendor::qti::hardware::bluetooth_audio::V2_0::AudioCapabilities>* _hidl_out_audioCapabilities;
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::vendor::qti::hardware::bluetooth_audio::V2_0::AudioCapabilities> &>(*_hidl_out_audioCapabilities),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "getProviderCapabilities", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwBluetoothAudioProvidersFactory::BnHwBluetoothAudioProvidersFactory(const ::android::sp<IBluetoothAudioProvidersFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "vendor.qti.hardware.bluetooth_audio@2.0", "IBluetoothAudioProvidersFactory") {
...
::android::status_t BnHwBluetoothAudioProvidersFactory::_hidl_openProvider(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&sessionType);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "openProvider", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_provider);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "openProvider", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothAudioProvidersFactory::_hidl_getProviderCapabilities(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&sessionType);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "getProviderCapabilities", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_audioCapabilities);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvidersFactory", "getProviderCapabilities", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BsBluetoothAudioProvidersFactory::BsBluetoothAudioProvidersFactory(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvidersFactory> impl) : ::android::hardware::details::HidlInstrumentor("vendor.qti.hardware.bluetooth_audio@2.0", "IBluetoothAudioProvidersFactory"), mImpl(impl) {
...
bool IBluetoothAudioProvidersFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvidersFactory",
