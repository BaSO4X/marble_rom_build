#define LOG_TAG "vendor.qti.hardware.bluetooth_audio@2.0::BluetoothAudioProvider"
...
#include <vendor/qti/hardware/bluetooth_audio/2.0/BnHwBluetoothAudioProvider.h>
#include <vendor/qti/hardware/bluetooth_audio/2.0/BsBluetoothAudioProvider.h>
...
const char* IBluetoothAudioProvider::descriptor("vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvider");
...
::android::hardware::Return<void> IBluetoothAudioProvider::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>> IBluetoothAudioProvider::castFrom(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider>> IBluetoothAudioProvider::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IBluetoothAudioProvider, ::android::hidl::base::V1_0::IBase, BpHwBluetoothAudioProvider>(
            parent, "vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvider", emitError);
}
...
BpHwBluetoothAudioProvider::BpHwBluetoothAudioProvider(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IBluetoothAudioProvider>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("vendor.qti.hardware.bluetooth_audio@2.0", "IBluetoothAudioProvider") {
}
...
// Methods from ::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider follow.
::android::hardware::Return<void> BpHwBluetoothAudioProvider::_hidl_startSession(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort>& hostIf, const ::vendor::qti::hardware::bluetooth_audio::V2_0::AudioConfiguration& audioConfig, startSession_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "startSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* startSession */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "startSession", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBluetoothAudioProvider::_hidl_streamStarted(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::vendor::qti::hardware::bluetooth_audio::V2_0::Status status) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamStarted", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamStarted", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBluetoothAudioProvider::_hidl_streamSuspended(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::vendor::qti::hardware::bluetooth_audio::V2_0::Status status) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamSuspended", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamSuspended", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBluetoothAudioProvider::_hidl_updateSessionParams(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::vendor::qti::hardware::bluetooth_audio::V2_0::SessionParams& sessionParams) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IBluetoothAudioProvider::updateSessionParams::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&sessionParams);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "updateSessionParams", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(4 /* updateSessionParams */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK)
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "updateSessionParams", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBluetoothAudioProvider::_hidl_endSession(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "endSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* endSession */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK)
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "endSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwBluetoothAudioProvider::BnHwBluetoothAudioProvider(const ::android::sp<IBluetoothAudioProvider> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "vendor.qti.hardware.bluetooth_audio@2.0", "IBluetoothAudioProvider") {
...
::android::status_t BnHwBluetoothAudioProvider::_hidl_startSession(
    ...
    ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort> hostIf;
    ::vendor::qti::hardware::bluetooth_audio::V2_0::AudioConfiguration* audioConfig;

    {
        ...
        hostIf = ::android::hardware::fromBinder<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioPort,::vendor::qti::hardware::bluetooth_audio::V2_0::BpHwBluetoothAudioPort,::vendor::qti::hardware::bluetooth_audio::V2_0::BnHwBluetoothAudioPort>(_hidl_binder);
    }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)audioConfig);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "startSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_dataMQ);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "startSession", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothAudioProvider::_hidl_streamStarted(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamStarted", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamStarted", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothAudioProvider::_hidl_streamSuspended(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamSuspended", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "streamSuspended", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothAudioProvider::_hidl_updateSessionParams(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::vendor::qti::hardware::bluetooth_audio::V2_0::SessionParams* sessionParams;

    size_t _hidl_sessionParams_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*sessionParams), &_hidl_sessionParams_parent,  const_cast<const void**>(reinterpret_cast<void **>(&sessionParams)));
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IBluetoothAudioProvider::updateSessionParams::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)sessionParams);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "updateSessionParams", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IBluetoothAudioProvider*>(_hidl_this->getImpl().get())->updateSessionParams(*sessionParams);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "updateSessionParams", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothAudioProvider::_hidl_endSession(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "endSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.qti.hardware.bluetooth_audio", "2.0", "IBluetoothAudioProvider", "endSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsBluetoothAudioProvider::BsBluetoothAudioProvider(const ::android::sp<::vendor::qti::hardware::bluetooth_audio::V2_0::IBluetoothAudioProvider> impl) : ::android::hardware::details::HidlInstrumentor("vendor.qti.hardware.bluetooth_audio@2.0", "IBluetoothAudioProvider"), mImpl(impl) {
...
bool IBluetoothAudioProvider::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("vendor.qti.hardware.bluetooth_audio@2.0::IBluetoothAudioProvider",
