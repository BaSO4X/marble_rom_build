...
namespace audio {
namespace common {
const char* Boolean::descriptor = "android.media.audio.common.Boolean";

binder_status_t Boolean::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Boolean::writeToParcel(AParcel* _aidl_parcel) const {
