...
namespace audio {
namespace common {
const char* Float::descriptor = "android.media.audio.common.Float";

binder_status_t Float::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Float::writeToParcel(AParcel* _aidl_parcel) const {
