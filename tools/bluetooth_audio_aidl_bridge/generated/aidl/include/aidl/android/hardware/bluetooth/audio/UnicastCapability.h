...
template <>
constexpr inline std::array<aidl::android::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag, 3> enum_values<aidl::android::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag> = {
