...
template <>
constexpr inline std::array<aidl::android::hardware::bluetooth::audio::LeAudioCodecConfiguration::Tag, 3> enum_values<aidl::android::hardware::bluetooth::audio::LeAudioCodecConfiguration::Tag> = {
