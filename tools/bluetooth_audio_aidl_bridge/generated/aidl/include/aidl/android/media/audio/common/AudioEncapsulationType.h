...
template <>
constexpr inline std::array<aidl::android::media::audio::common::AudioEncapsulationType, 3> enum_values<aidl::android::media::audio::common::AudioEncapsulationType> = {
  ...
  aidl::android::media::audio::common::AudioEncapsulationType::PCM,
};
